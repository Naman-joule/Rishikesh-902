...
const ReaderSidebar = ({
  ...
  const desktopClasses = "border-l border-orange-200 w-[280px] min-w-[280px] h-screen";
  ...
  return (
    <div className={`${desktopClasses} bg-gradient-to-b from-amber-50 to-orange-50 flex flex-col`}>
      ...
      <div className="flex-1 overflow-y-auto p-4 max-h-[calc(100vh-280px)]">
        <h3 className="mb-3 font-medium text-orange-800 flex items-center gap-2 sticky top-0 bg-gradient-to-b from-amber-50 to-orange-50 pb-2">
